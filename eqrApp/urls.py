...
urlpatterns = [
    ...
    path('save_employee_excel',views.save_employee_excel,name='save-employee-excel'),
    ...
    path('add-employee-excel',views.add_employee_excel,name='add-employee-excel'),
    path('id_testing',views.id_testing,name='id_testing'),
